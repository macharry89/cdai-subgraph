...
export class NewPendingImplementation extends EthereumEvent {
...
export class MarketListed extends EthereumEvent {
...
export class MarketEntered extends EthereumEvent {
...
export class MarketExited extends EthereumEvent {
...
export class NewCloseFactor extends EthereumEvent {
...
export class NewCollateralFactor extends EthereumEvent {
...
export class NewLiquidationIncentive extends EthereumEvent {
...
export class NewMaxAssets extends EthereumEvent {
...
export class Failure1 extends EthereumEvent {
...
export class Comptroller extends SmartContract {
  ...
  _setPendingAdmin(newPendingAdmin: Address): BigInt {
    let result = super.call("_setPendingAdmin", [
      EthereumValue.fromAddress(newPendingAdmin)
    ]);

    return result[0].toBigInt();
  }

  try__setPendingAdmin(newPendingAdmin: Address): CallResult<BigInt> {
    let result = super.tryCall("_setPendingAdmin", [
      EthereumValue.fromAddress(newPendingAdmin)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  comptrollerImplementation(): Address {
    let result = super.call("comptrollerImplementation", []);

    return result[0].toAddress();
  }

  try_comptrollerImplementation(): CallResult<Address> {
    let result = super.tryCall("comptrollerImplementation", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  _acceptImplementation(): BigInt {
    let result = super.call("_acceptImplementation", []);

    return result[0].toBigInt();
  }

  try__acceptImplementation(): CallResult<BigInt> {
    let result = super.tryCall("_acceptImplementation", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  pendingComptrollerImplementation(): Address {
    let result = super.call("pendingComptrollerImplementation", []);

    return result[0].toAddress();
  }

  try_pendingComptrollerImplementation(): CallResult<Address> {
    let result = super.tryCall("pendingComptrollerImplementation", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  _setPendingImplementation(newPendingImplementation: Address): BigInt {
    let result = super.call("_setPendingImplementation", [
      EthereumValue.fromAddress(newPendingImplementation)
    ]);
  ...
  try__setPendingImplementation(
    ...
    let result = super.tryCall("_setPendingImplementation", [
      EthereumValue.fromAddress(newPendingImplementation)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  _acceptAdmin(): BigInt {
    let result = super.call("_acceptAdmin", []);

    return result[0].toBigInt();
  }

  try__acceptAdmin(): CallResult<BigInt> {
    let result = super.tryCall("_acceptAdmin", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  isComptroller(): boolean {
    let result = super.call("isComptroller", []);

    return result[0].toBoolean();
  }

  try_isComptroller(): CallResult<boolean> {
    let result = super.tryCall("isComptroller", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  repayBorrowAllowed(
    ...
    let result = super.call("repayBorrowAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(payer),
      EthereumValue.fromAddress(borrower),
      EthereumValue.fromUnsignedBigInt(repayAmount)
    ]);
  ...
  try_repayBorrowAllowed(
    ...
    let result = super.tryCall("repayBorrowAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(payer),
      EthereumValue.fromAddress(borrower),
      EthereumValue.fromUnsignedBigInt(repayAmount)
  ...
  try_pendingAdmin1(): CallResult<Address> {
    let result = super.tryCall("pendingAdmin", []);
    if (result.reverted) {
      return new CallResult();
    }
  ...
  _setCloseFactor(newCloseFactorMantissa: BigInt): BigInt {
    let result = super.call("_setCloseFactor", [
      EthereumValue.fromUnsignedBigInt(newCloseFactorMantissa)
    ]);

    return result[0].toBigInt();
  }

  try__setCloseFactor(newCloseFactorMantissa: BigInt): CallResult<BigInt> {
    let result = super.tryCall("_setCloseFactor", [
      EthereumValue.fromUnsignedBigInt(newCloseFactorMantissa)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  liquidationIncentiveMantissa(): BigInt {
    let result = super.call("liquidationIncentiveMantissa", []);

    return result[0].toBigInt();
  }

  try_liquidationIncentiveMantissa(): CallResult<BigInt> {
    let result = super.tryCall("liquidationIncentiveMantissa", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  mintAllowed(cToken: Address, minter: Address, mintAmount: BigInt): BigInt {
    let result = super.call("mintAllowed", [
      EthereumValue.fromAddress(cToken),
  ...
  try_mintAllowed(
    ...
    let result = super.tryCall("mintAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(minter),
      EthereumValue.fromUnsignedBigInt(mintAmount)
    ]);
  ...
  _setLiquidationIncentive(newLiquidationIncentiveMantissa: BigInt): BigInt {
    let result = super.call("_setLiquidationIncentive", [
      EthereumValue.fromUnsignedBigInt(newLiquidationIncentiveMantissa)
    ]);
  ...
  try__setLiquidationIncentive(
    ...
    let result = super.tryCall("_setLiquidationIncentive", [
      EthereumValue.fromUnsignedBigInt(newLiquidationIncentiveMantissa)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  _setPriceOracle(newOracle: Address): BigInt {
    let result = super.call("_setPriceOracle", [
      EthereumValue.fromAddress(newOracle)
    ]);

    return result[0].toBigInt();
  }

  try__setPriceOracle(newOracle: Address): CallResult<BigInt> {
    let result = super.tryCall("_setPriceOracle", [
      EthereumValue.fromAddress(newOracle)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  getAccountLiquidity(
    ...
    let result = super.call("getAccountLiquidity", [
  ...
  try_getAccountLiquidity(
    account: Address
  ): CallResult<Comptroller__getAccountLiquidityResult> {
    let result = super.tryCall("getAccountLiquidity", [
      EthereumValue.fromAddress(account)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  liquidateBorrowAllowed(
    ...
    let result = super.call("liquidateBorrowAllowed", [
      EthereumValue.fromAddress(cTokenBorrowed),
      EthereumValue.fromAddress(cTokenCollateral),
      EthereumValue.fromAddress(liquidator),
      EthereumValue.fromAddress(borrower),
      EthereumValue.fromUnsignedBigInt(repayAmount)
    ]);
  ...
  try_liquidateBorrowAllowed(
    ...
    let result = super.tryCall("liquidateBorrowAllowed", [
      EthereumValue.fromAddress(cTokenBorrowed),
      EthereumValue.fromAddress(cTokenCollateral),
      EthereumValue.fromAddress(liquidator),
      EthereumValue.fromAddress(borrower),
  ...
  markets(param0: Address): Comptroller__marketsResult {
    let result = super.call("markets", [EthereumValue.fromAddress(param0)]);
  ...
  try_markets(param0: Address): CallResult<Comptroller__marketsResult> {
    let result = super.tryCall("markets", [EthereumValue.fromAddress(param0)]);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  checkMembership(account: Address, cToken: Address): boolean {
    let result = super.call("checkMembership", [
      EthereumValue.fromAddress(account),
      EthereumValue.fromAddress(cToken)
    ]);
  ...
  try_checkMembership(account: Address, cToken: Address): CallResult<boolean> {
    let result = super.tryCall("checkMembership", [
      EthereumValue.fromAddress(account),
      EthereumValue.fromAddress(cToken)
    ]);
    if (result.reverted) {
  ...
  maxAssets(): BigInt {
    let result = super.call("maxAssets", []);

    return result[0].toBigInt();
  }

  try_maxAssets(): CallResult<BigInt> {
    let result = super.tryCall("maxAssets", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  _supportMarket(cToken: Address): BigInt {
    let result = super.call("_supportMarket", [
      EthereumValue.fromAddress(cToken)
    ]);
  ...
  try__supportMarket(cToken: Address): CallResult<BigInt> {
    let result = super.tryCall("_supportMarket", [
      EthereumValue.fromAddress(cToken)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  getAssetsIn(account: Address): Array<Address> {
    let result = super.call("getAssetsIn", [
      EthereumValue.fromAddress(account)
    ]);
  ...
  try_getAssetsIn(account: Address): CallResult<Array<Address>> {
    let result = super.tryCall("getAssetsIn", [
      EthereumValue.fromAddress(account)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  try_comptrollerImplementation1(): CallResult<Address> {
    let result = super.tryCall("comptrollerImplementation", []);
    if (result.reverted) {
      return new CallResult();
    }
  ...
  transferAllowed(
    ...
    let result = super.call("transferAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(src),
      EthereumValue.fromAddress(dst),
      EthereumValue.fromUnsignedBigInt(transferTokens)
    ]);
  ...
  try_transferAllowed(
    ...
    let result = super.tryCall("transferAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(src),
      EthereumValue.fromAddress(dst),
      EthereumValue.fromUnsignedBigInt(transferTokens)
  ...
  enterMarkets(cTokens: Array<Address>): Array<BigInt> {
    let result = super.call("enterMarkets", [
      EthereumValue.fromAddressArray(cTokens)
    ]);

    return result[0].toBigIntArray();
  }

  try_enterMarkets(cTokens: Array<Address>): CallResult<Array<BigInt>> {
    let result = super.tryCall("enterMarkets", [
      EthereumValue.fromAddressArray(cTokens)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  liquidateCalculateSeizeTokens(
    ...
    let result = super.call("liquidateCalculateSeizeTokens", [
      EthereumValue.fromAddress(cTokenBorrowed),
      EthereumValue.fromAddress(cTokenCollateral),
      EthereumValue.fromUnsignedBigInt(repayAmount)
    ]);
  ...
  try_liquidateCalculateSeizeTokens(
    ...
    cTokenCollateral: Address,
    repayAmount: BigInt
  ): CallResult<Comptroller__liquidateCalculateSeizeTokensResult> {
    let result = super.tryCall("liquidateCalculateSeizeTokens", [
      EthereumValue.fromAddress(cTokenBorrowed),
      EthereumValue.fromAddress(cTokenCollateral),
      EthereumValue.fromUnsignedBigInt(repayAmount)
    ]);
  ...
  seizeAllowed(
    ...
    let result = super.call("seizeAllowed", [
      EthereumValue.fromAddress(cTokenCollateral),
      EthereumValue.fromAddress(cTokenBorrowed),
      EthereumValue.fromAddress(liquidator),
      EthereumValue.fromAddress(borrower),
      EthereumValue.fromUnsignedBigInt(seizeTokens)
    ]);
  ...
  try_seizeAllowed(
    ...
    let result = super.tryCall("seizeAllowed", [
      EthereumValue.fromAddress(cTokenCollateral),
      EthereumValue.fromAddress(cTokenBorrowed),
      EthereumValue.fromAddress(liquidator),
      EthereumValue.fromAddress(borrower),
  ...
  _setMaxAssets(newMaxAssets: BigInt): BigInt {
    let result = super.call("_setMaxAssets", [
      EthereumValue.fromUnsignedBigInt(newMaxAssets)
    ]);

    return result[0].toBigInt();
  }

  try__setMaxAssets(newMaxAssets: BigInt): CallResult<BigInt> {
    let result = super.tryCall("_setMaxAssets", [
      EthereumValue.fromUnsignedBigInt(newMaxAssets)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  borrowAllowed(
    ...
    let result = super.call("borrowAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(borrower),
      EthereumValue.fromUnsignedBigInt(borrowAmount)
    ]);
  ...
  try_borrowAllowed(
    ...
    let result = super.tryCall("borrowAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(borrower),
      EthereumValue.fromUnsignedBigInt(borrowAmount)
    ]);
  ...
  accountAssets(param0: Address, param1: BigInt): Address {
    let result = super.call("accountAssets", [
  ...
  try_accountAssets(param0: Address, param1: BigInt): CallResult<Address> {
    let result = super.tryCall("accountAssets", [
      EthereumValue.fromAddress(param0),
      EthereumValue.fromUnsignedBigInt(param1)
    ]);
    if (result.reverted) {
  ...
  try_pendingComptrollerImplementation1(): CallResult<Address> {
    let result = super.tryCall("pendingComptrollerImplementation", []);
    if (result.reverted) {
      return new CallResult();
    }
  ...
  _setCollateralFactor(
    ...
    let result = super.call("_setCollateralFactor", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromUnsignedBigInt(newCollateralFactorMantissa)
    ]);
  ...
  try__setCollateralFactor(
    ...
    let result = super.tryCall("_setCollateralFactor", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromUnsignedBigInt(newCollateralFactorMantissa)
    ]);
    if (result.reverted) {
  ...
  closeFactorMantissa(): BigInt {
    let result = super.call("closeFactorMantissa", []);

    return result[0].toBigInt();
  }

  try_closeFactorMantissa(): CallResult<BigInt> {
    let result = super.tryCall("closeFactorMantissa", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  redeemAllowed(
    ...
    let result = super.call("redeemAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(redeemer),
  ...
  try_redeemAllowed(
    ...
    let result = super.tryCall("redeemAllowed", [
      EthereumValue.fromAddress(cToken),
      EthereumValue.fromAddress(redeemer),
      EthereumValue.fromUnsignedBigInt(redeemTokens)
    ]);
  ...
  exitMarket(cTokenAddress: Address): BigInt {
    let result = super.call("exitMarket", [
      EthereumValue.fromAddress(cTokenAddress)
    ]);

    return result[0].toBigInt();
  }

  try_exitMarket(cTokenAddress: Address): CallResult<BigInt> {
    let result = super.tryCall("exitMarket", [
      EthereumValue.fromAddress(cTokenAddress)
    ]);
    if (result.reverted) {
      return new CallResult();
...
export class _acceptImplementationCall extends EthereumCall {
...
export class _setPendingImplementationCall extends EthereumCall {
...
export class RepayBorrowVerifyCall extends EthereumCall {
...
export class RepayBorrowAllowedCall extends EthereumCall {
...
export class _setCloseFactorCall extends EthereumCall {
...
export class _becomeCall extends EthereumCall {
...
export class MintVerifyCall extends EthereumCall {
...
export class LiquidateBorrowVerifyCall extends EthereumCall {
...
export class MintAllowedCall extends EthereumCall {
...
export class _setLiquidationIncentiveCall extends EthereumCall {
...
export class RedeemVerifyCall extends EthereumCall {
...
export class _setPriceOracleCall extends EthereumCall {
...
export class BorrowVerifyCall extends EthereumCall {
...
export class LiquidateBorrowAllowedCall extends EthereumCall {
...
export class TransferVerifyCall extends EthereumCall {
...
export class SeizeVerifyCall extends EthereumCall {
...
export class _supportMarketCall extends EthereumCall {
...
export class TransferAllowedCall extends EthereumCall {
...
export class EnterMarketsCall extends EthereumCall {
...
export class SeizeAllowedCall extends EthereumCall {
...
export class _setMaxAssetsCall extends EthereumCall {
...
export class BorrowAllowedCall extends EthereumCall {
...
export class _setCollateralFactorCall extends EthereumCall {
...
export class RedeemAllowedCall extends EthereumCall {
...
export class ExitMarketCall extends EthereumCall {
...
export class Constructor1Call extends EthereumCall {
